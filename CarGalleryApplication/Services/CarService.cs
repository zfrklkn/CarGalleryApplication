using CarGalleryApplication.Models;
using Microsoft.Extensions.Configuration;
using MongoDB.Driver;
using System.Collections.Generic;

namespace CarGalleryApplication.Services
{
    public class CarService
    {
        ...
        {
            MongoClient client = new MongoClient(config.GetConnectionString("CarGalleryConnection"));
